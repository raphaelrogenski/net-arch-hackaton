...
{
    public class RejectKitchenOrderHandler : IRejectKitchenOrderHandler
    {
        private readonly IKitchenOrderRepository kitchenOrderRepository;
        private readonly IOrderRepository orderRepository;
        private readonly IUserRepository userRepository;

        public RejectKitchenOrderHandler(IKitchenOrderRepository kitchenOrderRepository, IOrderRepository orderRepository, IUserRepository userRepository)
        {
        ...
        public async Task<bool> HandleAsync(string userEmail, Guid id, CancelKitchenOrderRequest request)
        {
            ...
            {
                Status = KitchenOrderStatusEnum.Rejected,
                Notes = request.Notes,
                IdOrder = order.Id,
                IdHandledBy = user.Id,
            };
